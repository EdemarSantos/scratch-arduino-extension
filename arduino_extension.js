...
(function(ext) {
  ...
  var blocks = {
    ...
    pt: [
      ...
      [' ', 'conectar %m.hwIn para analógico %n', 'connectHW', 'potenciômetro', 0],
      ['-'],
      ...
      ['-'],
      ['h', 'quando %m.buttons is %m.btnStates', 'whenButton', 'botão A', 'pressionado'],
      ['b', '%m.buttons pressionado?', 'isButtonPressed', 'botão A'],
      ['-'],
      ['h', 'quando %m.hwIn %m.ops %n%', 'whenInput', 'potenciômetro', '>', 50],
      ['r', 'read %m.hwIn', 'readInput', 'potenciômetro'],
      ['-'],
      [' ', 'estado digital do pino %n %m.outputs', 'digitalWrite', 1, 'ligado'],
      [' ', 'estado analógico do pino %n to %n%', 'analogWrite', 3, 100],
      ['-'],
      ['h', 'quando pino %n está %m.outputs', 'whenDigitalRead', 1, 'ligado'],
      ['b', 'pino %n ligado?', 'digitalRead', 1],
      ['-'],
      ['h', 'quando valor analógico %n %m.ops %n%', 'whenAnalogRead', 1, '>', 50],
      ['r', 'ler valor analógico %n', 'analogRead', 0],
      ['-'],
  ...
  var menus = {
    ...
    pt: {
      buttons: ['botão A', 'botão B', 'botão C', 'botão D'],
      btnStates: ['pressionado', 'solto'],
      hwIn: ['potenciômetro', 'sensor de luz', 'sensor de temperatura'],
      hwOut: ['led A', 'led B', 'led C', 'led D', 'botão A', 'botão B', 'botão C', 'botão D', 'servo A', 'servo B', 'servo C', 'servo D'],
      leds: ['led A', 'led B', 'led C', 'led D'],
